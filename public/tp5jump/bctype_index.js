...
layui.use('table', function(){
  ...
  table.render({    //表格渲染 
    ...
    ,cols: [[	   
      ...
      ,{field:'bcname', width:100, title: '博彩类型',align:'center'}
      ,{field:'bcimg', width:120, title: '博彩图片',align:'center'}
      ,{field:'status', width:120, title: '显示状态',align:'center'}
      ,{field:'api', Minwidth:260, title: '接口',align:'center'}
      ,{field:'opentime', width:190, title: '开奖周期时间',align:'center'}
      ,{field:'opencodelength', width:120, title: '开奖号位数',align:'center'} 
      ,{field:'time', width:190, title: '添加时间',align:'center'} 
  ...
  table.on('tool(Idtableb)', function(obj){
	 ...
	 //编辑
	   ...
	   //设置玩法
	   else if(obj.event === 'setplay'){
		   window.location.href="setplay?id="+id;	    	
	    		    	
	    }
	   //设置规则
	   else if(obj.event === 'setrule'){
		   window.location.href="setrule?id="+id;	    	
