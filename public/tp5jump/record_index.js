...
layui.use('table', function(){
  ...
  table.render({    //表格渲染 
    ...
    ,cols: [[
      ...
      ,{field:'agentname', Width:60, title: '版本名称',align:'center'}
      ,{field:'validity', Width:60, title: '有效期',align:'center'}
      ,{field:'money', Width:80, title: '支付金额',align:'center'}
      ,{field:'status', Width:80, title: '支付结果',align:'center'}
      ,{field:'createtime', Width:170, title: '时间',align:'center'}
  ...
  table.on('tool(Idtableb)', function(obj){
	    ...
	    //删除
	   if(obj.event === 'del'){
	      layer.confirm('该操作不可恢复，确定要删除吗', function(index){	    		    		    	 
